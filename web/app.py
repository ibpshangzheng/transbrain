    ...
    try:
        ...
        if data_type == 'Table':
            ...
            if direction == "human to mouse":
                ...
                data_df = tb.base.get_region_phenotypes(img, atlas_dict = atlas_dict, atlas_type=atlas_flag, region_type=region_type)
            else:
                atlas_dict = tb.atlas.fetch_mouse_atlas(region_type=region_type)
                data_df = tb.base.get_region_phenotypes(img, atlas_dict = atlas_dict, atlas_type='mouse', region_type=region_type)
